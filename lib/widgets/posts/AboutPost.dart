...
class AboutPost extends StatelessWidget {
  AboutPost(
      {this.phoneNo, this.address, this.website, this.mail, this.workingHours});
  ...
  Widget build(BuildContext context) {
    TextStyle style = TextStyle(
        fontSize: PetsTheme.getSmallFont(), color: PetsTheme.blackTextColor);
    SizedBox spacer = SizedBox(
      height: PetsTheme.getSmallPadMarg(),
    );
